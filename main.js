...
draw_circle = "";
draw_rect= "";
 var SpeechRecognition = window.wibkitSpeechRecoginition;
 ...
 recoginition.onresult = function(event){
    ...
    if(content =="rectangle"){
        ...
        document.getElementById("status").innerHTML = "strated drawing rectangle ";
        draw_rect = "set";
    }
    if(content =="circle"){
        x = Math.floor(Math.random() * 900);
        y = Math.floor(Math.random() * 600);
        document.getElementById("status").innerHTML = "strated drawing circle";
        draw_rect = "set";
    }
 }
 function setup(){
